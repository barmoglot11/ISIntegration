...
text_to_check = ("у вас это опциональный пункт, по результатам анализа предметной области, может быть построена модель "
                 "текущей деятельности. Это актуально для тех, кто какие-то сайты/интернет-магазины разрабатывает или "
                 "решения, которые автоматизируют какую-то деятельности. Для остальных достаточно п.4")
